...
" Please delete all the sourcing and copy and paste the configs and replace UNIX ones with Windows options that have been provided in each file in settings and plugins directories into
" init.vim file if you're using Windows.
